...
\usepackage{parskip}
\usepackage{xeCJK} % Add CJK support
\setCJKmainfont{Noto Sans CJK JP}[AutoFakeBold=true] % Use Noto Sans Japanese font
\setmainfont{Noto Serif} % Set a compatible main font
\usepackage{hyperref}
